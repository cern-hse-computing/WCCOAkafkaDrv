 ...
 *
 **/
#ifndef kafkaINT64TRANS_HXX_
#define kafkaINT64TRANS_HXX_

#include <Transformation.hxx>
namespace Transformations {


class kafkaInt64Trans: public Transformation {
	/*!
	 *  Transformations typ
...
private:
	const static uint8_t size = sizeof(int64_t);
};

}
#endif /* kafkaINT64TRANS_HXX_ */
