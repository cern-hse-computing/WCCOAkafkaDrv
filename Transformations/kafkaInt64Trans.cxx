...
PVSSboolean kafkaInt64Trans::toPeriph(PVSSchar *buffer, PVSSuint len, const Variable &var, const PVSSuint subix) const {
...
VariablePtr kafkaInt64Trans::toVar(const PVSSchar *buffer, const PVSSuint dlen, const PVSSuint subix) const {
